      ...
      <table className="w-full text-left">
        <thead>
          <tr className="border-b border-fd-border bg-fd-card">
            ...
            <th className="py-3 px-4 text-sm font-medium text-center text-fd-primary bg-fd-primary/5">podspawn</th>
        ...
        <tbody>
          {rows.map((row) => (
            <tr key={row.feature} className="border-b border-fd-border last:border-0 transition-colors hover:bg-fd-accent/5">
              <td className="py-3 pr-4 pl-4 text-sm font-medium text-fd-foreground">{row.feature}</td>
              <td className="py-3 px-4 text-center bg-fd-primary/5"><CellContent value={row.podspawn} isPodspawn /></td>
              <td className="py-3 px-4 text-center"><CellContent value={row.containerSSH} /></td>
              <td className="py-3 px-4 text-center"><CellContent value={row.coder} /></td>
              <td className="py-3 px-4 text-center"><CellContent value={row.codespaces} /></td>
            </tr>
          ))}
        </tbody>
      </table>
