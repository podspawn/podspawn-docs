...
2. Creates a container with a non-root user (UID 1000, home at `/home/<username>`, passwordless sudo)
3. Attaches an interactive shell as that user
4. When you disconnect (exit the shell or close the terminal), the container is destroyed
