...
<Tabs items={['Node.js', 'Python', 'Go', 'Rust']}>
<Tab value="Node.js">
...
<Tabs items={['apt package', 'Known runtime', 'Unknown versioned']}>
<Tab value="apt package">
