...
### Local mode (created by setup wizard)

| Path | Purpose |
|---|---|
| `~/.podspawn/config.yaml` | Local defaults (image, shell, resources, lifecycle) |
| `~/.podspawn/podfile.yaml` | Default Podfile (packages, services from wizard choices) |
