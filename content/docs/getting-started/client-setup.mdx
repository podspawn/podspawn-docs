...
<Accordions>
<Accordion title="Manual setup (without podspawn setup)">
If you don't want to run `podspawn setup`, add this to `~/.ssh/config` yourself:
...
<Accordion title="Without the client binary at all">
