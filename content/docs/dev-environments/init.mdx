...
Templates ship embedded in the podspawn binary. The full set (with additional templates and bases) is also available in the [community registry](https://github.com/podspawn/podfiles).
