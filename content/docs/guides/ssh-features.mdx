...
<TypeTable type={{
  'Interactive shell': { type: '"Supported"', description: 'Session router, ~30 lines (PTY, SIGWINCH)' },
  'Remote commands': { type: '"Supported"', description: 'Session router, 0 lines (default exec path)' },
  'SFTP': { type: '"Supported"', description: 'Session router, ~5 lines (detection)' },
  'scp': { type: '"Supported"', description: 'Session router, 0 lines (default exec path)' },
  'rsync over SSH': { type: '"Supported"', description: 'Session router, 0 lines (default exec path)' },
  'Local port forwarding (-L)': { type: '"Supported"', description: 'sshd natively, 0 lines' },
  'Remote port forwarding (-R)': { type: '"Supported"', description: 'sshd natively, 0 lines' },
  'Dynamic forwarding / SOCKS (-D)': { type: '"Supported"', description: 'sshd natively, 0 lines' },
  'Agent forwarding (-A)': { type: '"Supported"', description: 'sshd + bind mount, ~15 lines' },
  'X11 forwarding': { type: '"Supported"', description: 'sshd natively, ~3 lines (env passthrough)' },
  'Mosh': { type: '"Not supported"', description: 'Requires UDP, cannot be tunneled through SSH' },
}} />
...
<TypeTable type={{
  'bash': { type: '"bash"', description: 'Interactive sessions' },
  'sftp-server': { type: '"openssh-sftp-server"', description: 'SFTP, VS Code Remote' },
  'scp': { type: '"openssh-client"', description: 'scp transfers' },
  'rsync': { type: '"rsync"', description: 'rsync transfers' },
  'git': { type: '"git"', description: 'Agent forwarding (useful), repo cloning' },
  'locales': { type: '"locales"', description: 'Proper UTF-8 support' },
}} />
