...
The server config (`/etc/podspawn/config.yaml`) has a `resources.max_containers` setting (default: 50). If you're running a lot of concurrent sessions, you may hit this limit.
