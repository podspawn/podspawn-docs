...
<Banner>Start with podspawn doctor -- it catches most common issues automatically.</Banner>
...
<Accordions>
<Accordion title="Password prompt instead of key authentication">
...
<Accordion title="Locked user account">
...
<Accordion title="Wrong key or key not registered">
...
<Accordion title="sshd not reloaded after config changes">
...
<Accordion title="AuthorizedKeysCommand not configured">
...
<Accordion title="Debugging with sshd logs">
...
<Accordion title="Image not pulled">
...
<Accordion title="Max containers exceeded">
...
<Accordion title="Key file permissions">
...
<Accordion title="state.db ownership">
...
<Accordions>
<Accordion title="SFTP not working (server mode)">
...
<Accordion title="Grace period not working">
...
<Accordions>
<Accordion title="sshd configuration (server only)">
...
<Accordion title="Docker connectivity">
...
<Accordion title="State database">
...
<Accordion title="Lock directory">
...
<Accordion title="Container cleanup">
...
<Accordion title="Podspawn log file">
...
<Cards>
  ...
  <Card title="Admin Commands" href="/docs/cli/admin-commands" />
</Cards>
